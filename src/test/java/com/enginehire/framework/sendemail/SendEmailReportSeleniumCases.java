package com.enginehire.framework.sendemail;
...
@Listeners(com.enginehire.framework.sendemail.ListenerTest.class)
public class SendEmailReportSeleniumCases {
	...
	public static void f() {
		try {
			...
			String path = "E:\\manifest\\test-output\\TestReport.html";
			...
			msg.setSubject("Test Status Report of manifest");
			BodyPart msgBody = new MimeBodyPart();
			// Setting email's message body
			msgBody.setText("This is test report through mail of manifest");
